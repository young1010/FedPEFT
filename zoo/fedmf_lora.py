...
class model(BaseModel):
    ...
    def __init_weight(self, ):
        nn.init.xavier_uniform_(self.embedding_item.emb.weight)
...
class Server(ServerBase):
    ...
    def aggregation(self, user_list, model_list, num_list, loss_list,):
        ...
        #     self.models[user] = {"weight":model_list[i]["embedding_p.weight"],}
        #                         #  "linear.weight":model_list[i]["embedding_p.linear.weight"]}
